...
<template>
  <div>
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>SQL列表</el-breadcrumb-item>
    </el-breadcrumb>
    <!-- 搜索筛选 -->
    <el-form :inline="true"
             :model="formInline"
      ...
      <el-form-item>
        <el-select size="small"
                   ...
                   placeholder="请选择">
          <el-option v-for="type in payType"
                     :label="type.key"
                     :value="type.value"
    ...
    <el-dialog :title="title"
      ...
      <el-form label-width="120px"
        ...
        <el-form-item label="微信子商户"
                      prop="subMchId">
          <el-input size="small"
                    v-model="editForm.subMchId"
                    auto-complete="off"
                    placeholder="请输入微信子商户"></el-input>
        </el-form-item>
        ...
        <el-form-item label="通知回调"
                      prop="notifyUrl">
          <el-input size="small"
                    v-model="editForm.notifyUrl"
                    auto-complete="off"
                    placeholder="请输入通知回调"></el-input>
        </el-form-item>
        <el-form-item label="加密类型"
          ...
          <el-input size="small"
                    ...
                    auto-complete="off"
                    placeholder="请输入加密类型"></el-input>
        </el-form-item>
        <el-form-item label="商户签名密钥"
                      prop="partnerKey">
          <el-input size="small"
                    v-model="editForm.partnerKey"
                    auto-complete="off"
                    placeholder="请输入商户签名密钥"></el-input>
        </el-form-item>
        <el-form-item label="支付宝卖家"
                      prop="sellerUserId">
          <el-input size="small"
                    v-model="editForm.sellerUserId"
                    auto-complete="off"
                    placeholder="请输入支付宝卖家"></el-input>
        </el-form-item>
        <el-form-item label="微信证书路径"
          ...
          <el-input size="small"
                    ...
                    auto-complete="off"
                    placeholder="请输入微信证书路径"></el-input>
        </el-form-item>
        <el-form-item label="微信证书密码"
                      prop="certPassword">
          <el-input size="small"
                    v-model="editForm.certPassword"
                    auto-complete="off"
                    placeholder="请输入微信证书密码"></el-input>
        </el-form-item>
        ...
        if (valid) {
          ConfigSave(this.editForm)
            ...
            .catch(err => {
              this.editFormVisible = false
              this.loading = false
              this.$message.error('SQL列表信息保存失败，请稍后再试！')
            })
        } else {
          return false
        }
      ...
      this.$confirm('确定要删除吗?', '信息', {
        ...
        .then(() => {
          ConfigDelete(row.deptId)
            ...
            .catch(err => {
              this.loading = false
              this.$message.error('SQL列表信息删除失败，请稍后再试！')
            })
        })
        .catch(() => {
          this.$message({
